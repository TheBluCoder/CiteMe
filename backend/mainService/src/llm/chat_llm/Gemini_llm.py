...
class Genai_cite:
    ...
    def __init__(self, api_key:str= os.getenv("GOOGLE_API_KEY"), llm_model:str=f'models/{model}'):
        self.api_key = api_key
        self.client = genai.Client(api_key=self.api_key)
        self.llm_model = llm_model
    
        
    async def merge_citation(self, text: List[Dict[str, str]], format: str) -> Dict | bool:
        try:
